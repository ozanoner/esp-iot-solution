...
static ina219_handle_t ina219 = NULL;
static i2c_bus_handle_t i2c_bus = NULL;

static void ina219_test_init(void)
{
    i2c_config_t conf = {
...
static void ina219_test_deinit()
{
    ina219_delete(ina219);
    ina219 = NULL;
    i2c_bus_delete(&i2c_bus);
}

static void ina219_test_get_data()
{
    float vloatge = 0;
    float current = 0;
    int cnt = 2;
...
TEST_CASE("ina219_driver", "[ina219_driver]")
{
    ina219_test_init();
    ina219_test_get_data();
    ina219_test_deinit();
}
